---
title: 'Data Performance : Practical Guide to Impact of Indexing'
...
images: ['/blog/static/blog/data-performance-practical-guide/cover.png']
# layout: PostSimple
...
1. **Creating the Database:** Our experiment began by establishing a database in MySQL. We sourced our data from a CSV file (you can access the file [here](link_to_csv_file)) and populated the database with this information.
...
![Results](/blog/static/blog/data-performance-practical-guide/cover.png)
